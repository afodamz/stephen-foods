<template>
  <div class="offCanvas__minicart" :class="{ active: active, '': !active }">
    ...
    <div class="minicart__amount">
      ...
      <div class="minicart__amount_list d-flex justify-content-between">
        <span>Total:</span>
        <span><b>${{(cartItems.reduce(function (acc, obj) { return acc + obj.price; }, 0) * cartItems.reduce(function (acc, obj) { return acc + obj.quantity; }, 0)).toLocaleString('en-US')}}</b></span>
      </div>
    </div>
    <div class="minicart__conditions text-center">
      ...
      <label class="minicart__conditions--label" for="accept"
        >I agree with the
        <a class="minicart__conditions--link" href="privacy-policy.html"
          >Privacy Policy</a
        ></label
      >
    </div>
