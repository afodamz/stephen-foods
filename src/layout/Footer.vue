<template>
  <footer class="footer__section footer__section3 footer__bg">
        ...
        <div class="row main__footer--wrapper footer__top--row">
          <div
            class="
              ...
              footer__col--width
              col-md-7
              footer__col--padding footer__col--order
            "
          >
            <div class="footer__widget">
              <h3 class="footer__widget--title sm__footer--widget__bock">
                About Us
                <button
              ...
              <div class="footer__widget--inner">
                <a class="footer__widget--logo" href="index-2.html"
                  ><img src="assets/img/drive/logo.jpeg" alt="footer-logo"
                /></a>
                <p class="footer__widget--desc m-0">
                  The variety of products available at our store at the moment
                  is vast, but we still continue to widen our assortment.
                </p>
                <ul class="footer__widget--social d-flex">
                  <li class="footer__widget--social__list">
                    <a
                      class="footer__widget--social__icon"
                      target="_blank"
                  ...
                  <li class="footer__widget--social__list">
                    <a
                      class="footer__widget--social__icon"
                      target="_blank"
                      href="https://www.instagram.com/stefeni_foods/"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="17.497"
          ...
          <div
            class="col-lg-6 col-md-6 footer__col--padding footer__col--order"
          >
            <div class="footer__widget">
              ...
              <div class="footer__widget--inner">
                ...
                <div class="newsletter__subscribe">
                  <form class="newsletter__subscribe--form" action="#">
                    ...
                    <button
                      class="newsletter__subscribe--button"
                      @click="saveMail"
                      type="submit"
                    >
                      subscribe
          ...
          <div class="col-12 col-md-auto">
            <p class="copyright__content">
              ...
              <router-link
                ...
                >Stefeni</router-link
              >
              . All Rights Reserved.Design By Stefeni
            </p>
          </div>
          <!-- <div class="col-12 col-md-auto">
    ...
    <img
      class="footer__position--shape__one"
      src="assets/img/other/footer-shape1.png"
      alt="footer-shape"
    />
    <img
      class="footer__position--shape__two"
...
export default {
  ...
  methods: {
    saveMail: function () {
      axios
        .post(`http://localhost:8086/client/create`, {
          email: this.email,
        })
        ...
        .catch(function (error) {
          console.log(error);
          Vue.$toast.error("Mail Registered successfully.", {
            // override the global option
            position: "bottom",
          });
        });
