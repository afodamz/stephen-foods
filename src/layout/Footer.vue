        ...
        <div class="container">
            <div class="footer__top footer__section3--topbar">
                <div class="row main__footer--wrapper footer__top--row">
                    <div class="col-lg-6 footer__col--width col-md-7 footer__col--padding footer__col--order">
                        <div class="footer__widget">
                            ...
                            <div class="footer__widget--inner">
                                <a class="footer__widget--logo" href="index-2.html"><img
                                        src="assets/img/drive/logo.jpeg" alt="footer-logo"></a>
                    ...
                    <div class="col-lg-6 col-md-6 footer__col--padding footer__col--order">
                        <div class="footer__widget">
            ...
            <div class="footer__bottom">
                <div class="row justify-content-between align-items-center">
                    <div class="col-12 col-md-auto">
                        <p class="copyright__content">Copyright © 2022 <router-link tag="a" class="copyright__content--link text__primary" class-active="active" to="/">Stefeni</router-link>
                             . All Rights Reserved.Design By Stefeni</p>
                    </div>
                    <!-- <div class="col-12 col-md-auto">
